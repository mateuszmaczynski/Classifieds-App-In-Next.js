  ...
  <footer className="text-gray-600 body-font">
    <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
      ...
      <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
        <a aria-label="Facebook" href="https://www.facebook.com" className="text-gray-500">
          <svg
            fill="currentColor"
            strokeLinecap="round"
        ...
        <a aria-label="Twitter" href="https://twitter.com" className="ml-3 text-gray-500">
          <svg
            fill="currentColor"
            strokeLinecap="round"
            strokeLinejoin="round"
        ...
        <a aria-label="Instagram" href="https://www.instagram.com" className="ml-3 text-gray-500">
          <svg
            fill="none"
            stroke="currentColor"
            strokeLinecap="round"
        ...
        <a aria-label="Linkedin" href="https://www.linkedin.com" className="ml-3 text-gray-500">
          <svg
            fill="currentColor"
            stroke="currentColor"
            strokeLinecap="round"
